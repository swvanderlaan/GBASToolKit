...
if(!is.na(opt$projectdir) & !is.na(opt$datagwas) & !is.na(opt$outputdir)) {
  ...
  VectorOfColumnsWeWant <- c("^marker$", "^snp$", "^rsid$", "^snpid$",
                             ...
                             "^position$", "^bp$", "^pos$",
                             "^effect[_]allele$", "^minor[_]allele$", "^risk[_]allele$", "^coded[_]allele$", "^reference[_]allele$", 
                             "^effectallele$", "^minorallele$", "^riskallele$", "^codedallele$", "^referenceallele$", 
  ...
  GWASDATA_RAWSELECTION <- select(GWASDATA_RAWSELECTION, N = matches("^n_samples$"), everything())
  ...
  #### Rename columns -- reference allele
  GWASDATA_RAWSELECTION <- select(GWASDATA_RAWSELECTION, EffectAllele = matches("^reference[_]allele$"), everything())
  GWASDATA_RAWSELECTION <- select(GWASDATA_RAWSELECTION, EffectAllele = matches("^referenceallele$"), everything())
  ...
  GWASDATA_RAWSELECTION <- select(GWASDATA_RAWSELECTION, EffectAllele = matches("^risk[_]allele$"), everything())
  GWASDATA_RAWSELECTION <- select(GWASDATA_RAWSELECTION, EffectAllele = matches("^riskallele$"), everything())
